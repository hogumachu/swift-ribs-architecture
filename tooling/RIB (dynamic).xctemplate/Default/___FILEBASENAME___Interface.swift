...
public struct ___VARIABLE_productName___ComponentDependency {
  public init() {}
}

public protocol ___VARIABLE_productName___Buildable: Buildable {
  func build(
    with dynamicBuildDependency: ___VARIABLE_productName___BuildDependency,
    _ dynamicComponentDependency: ___VARIABLE_productName___ComponentDependency
